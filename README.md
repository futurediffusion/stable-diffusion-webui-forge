...
Simple UI mode toggle available in **Settings > UI alternatives** for a Foocus-like minimal interface. A button in the top-left allows quickly switching modes.
